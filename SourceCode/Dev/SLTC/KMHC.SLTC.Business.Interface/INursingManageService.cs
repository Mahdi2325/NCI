...
namespace KMHC.SLTC.Business.Interface
{
    public interface INursingManageService : IBaseService
    {
        ...
        #region 评估量表
        BaseResponse<IList<Evaluation>> QueryEvaluationList(NursingFilter request);
        ...
        BaseResponse<IList<REGQUESTION>> GetEvaluationHis(NursingFilter request);
        ...
        #region 護理需求
        BaseResponse<IList<Evaluation>> QueryNurDemandEvalList(NursingFilter request);
