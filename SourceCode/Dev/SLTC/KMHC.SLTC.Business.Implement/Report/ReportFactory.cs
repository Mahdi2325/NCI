...
namespace KMHC.SLTC.Business.Implement.Report
{
    public  class ReportFactory
    {
        ...
        public static BaseReport CreateReport(string type, long id, DateTime startDate, DateTime endDate,string imagePathright,string imagePathnull)
        {
            if (string.IsNullOrWhiteSpace(type))
            {
                throw new Exception("type为空");
            ...
            report.StartDate = startDate;
            report.EndDate = endDate;
            report.imagePathright = imagePathright;
            report.imagePathnull = imagePathnull;
