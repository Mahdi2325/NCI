...
namespace KMHC.SLTC.WebController
{
    public partial class ReportController : Controller
    {
        ...
        {
            //入住72小時內腸胃道出血而非計劃性轉到急性醫院住院人次
            //因腸胃道出血而非計劃性轉到急性醫院住院人次
        ...
        private void P22Operation(WordDocument doc)
        {
            ...
            var keys = new[] { "心血管代償機能減退", "骨折之治療或評估", "腸胃道出血", "感染", "其他內外科原因" };
            for (int i = 0; i < 5; i++)
            {
                if (nTotal == 0)
                {
        ...
        private void Infectionperation(WordDocument doc)
        {
            ...
            dynamic[] tags = new dynamic[] { 
                ...
                new { Type = "003", Value = "003", Text = "当月使用存留導尿管泌尿道感染人次(dl)" },
                new { Type = "004", Value = "004", Text = "当月未使用存留導尿管泌尿道感染人次(d2)" }, 
                new { Type = "005", Value = "005", Text = "疥瘡感染人次(g)" }
            };
