...
namespace KMHC.SLTC.Business.Entity
{
    public class DC_ReferrallistsModel
    {
        ...
        public string OriginPlace { get; set; }//籍貫
        public string Phone { get; set; }//個案電話
        public string PermanentAddress { get; set; }//戶籍地址
        public string LivingAddress { get; set; }//居住地址
        public string Language { get; set; }//溝通語言
        public string MerryState { get; set; }//婚姻狀況
        public string ObstacleManual { get; set; }//手冊別
        public string DiseaseInfo { get; set; }//疾病狀況
        //public string SiologicalState { get; set; }//生理狀況
