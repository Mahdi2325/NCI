    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/Content/Index/js").Include(
                        ...
                        , "~/Content/uploadify/webuploader.min.js"
                        //, "~/Content/MyDatePicker/WdatePicker.js"
            ...
            bundles.Add(new ScriptBundle("~/Scripts/AppCommon").Include(
                        ...
                        , "~/AppScripts/components/selectMultipleItems/*.js"
                        ...
                        , "~/AppScripts/components/inputAreaCode/*.js"
                       ));
            ...
            bundles.Add(new ScriptBundle("~/Scripts/NCI").Include(
                  "~/AppScripts/home/NCIApp.js"
                  , "~/AppScripts/route/NCIRoute.js"
                  , "~/AppScripts/report/*.js"
                  , "~/AppScripts/NCIA/*.js"
                  , "~/AppScripts/controllers/NCIP/*.js"
                  , "~/AppScripts/controllers/indexCtrl.js"
                  , "~/AppScripts/controllers/report/*.js"
                  , "~/AppScripts/controllers/userControllers.js"
                  , "~/AppScripts/controllers/roleControllers.js"
                  , "~/AppScripts/controllers/changeMyPassController.js"
                  ));
        }
    }
}